...
def generate_smart_recommendations(report: dict) -> list[dict]:
    ...
    if savings_pct >= 75:
        ...
        recommendations.append({
            ...
            "suggestion": "Improve your summarization logic to save more tokens. Try LLM-based summarization.",
            "priority": "high",
        })
    ...
    if quality_score >= 90:
        ...
        recommendations.append({
            ...
            "suggestion": "Use better embeddings or increase search depth to improve trap question accuracy.",
            "priority": "high",
        })
    ...
    if naive_per_turn and len(naive_per_turn) > 1:
        ...
        if growth > 0.5:
            recommendations.append({
                ...
                "suggestion": "Token usage is growing too fast. Consider pruning old memories or increasing compression ratio.",
                "priority": "medium",
            })
    ...
    if len(insights) >= 4:
        recommendations.append({
            ...
            "suggestion": "Your architecture is solid. Consider adding caching or multi-level memory.",
            "priority": "low",
        })
